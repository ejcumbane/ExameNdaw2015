	...
	<div class="row"><br /><br />
		...
		$base_url = array('plugin'=>null,'controller' => 'pedidos', 'action' => 'indextipo');
		...
		?>
			<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover">
				<tr>
					<td width="500"><?php echo $this->Form->input('search', array('class' => 'form-control', 'placeholder'=>'Inserir o id da pizza...','label'=>FALSE));?></td>
