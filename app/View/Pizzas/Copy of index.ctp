		...
		<div class="col-md-12">
			...
			<?php echo $this->Html->link($pizza['Categoria']['name'], array('controller' => 'categorias', 'action' => 'view', $pizza['Categoria']['id'])); ?>
						...
						<td class="actions">
							...
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit"></span>', array('action' => 'edit', $pizza['Pizza']['id']), array('escape' => false)); ?>
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $pizza['Pizza']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $pizza['Pizza']['id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
